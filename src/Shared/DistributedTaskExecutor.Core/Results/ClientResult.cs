...
public class ClientResult<T> : Result<T>
{
    ...
    public new static ClientResult<T> Success(T value)
    {
        return new ClientResult<T>(value);
    }

    public static ClientResult<T> Failure(Error error)
    {
...
public class ClientResult : Result
{
    ...
    public static ClientResult Failure(Error error)
    {
        return new ClientResult(error);
    }

    public static ClientResult Failure(ClientError error)
    {
        return new ClientResult(error);
    }
